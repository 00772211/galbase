HTML = `
	<div class="board_2nd">
		<a href="/topic/add" target="_blank" style="color: black"><span><img src="/data/imgs/new.png" style="width: 20px;" alt="图片加载失败">发帖</span></a>
		...
		<span id="online_count"><img src="/data/imgs/star.png" style="width: 18px;" alt="图片加载失败">今日在线</span>
		<span id="highest_online"><img src="/data/imgs/star.png" style="width: 18px;" alt="图片加载失败">最高在线</span>
		<span id="topics_count"><img src="/data/imgs/star.png" style="width: 18px;" alt="图片加载失败">论坛帖数</span>
	</div>
`
